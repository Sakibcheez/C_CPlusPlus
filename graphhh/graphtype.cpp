...
//change <=. we have used equal to later
...
template<class VertexType>void
...
{
    int fromIndex = IndexIs(vertices, u);
    int toIndex = IndexIs(vertices, v);
